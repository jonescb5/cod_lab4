...
EAStep vivado -log processor_board_implementation.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processor_board_implementation.tcl -notrace
